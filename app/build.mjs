...
const template = readFileSync(join(here, 'scriptable', 'Tasks.template.js'), 'utf8');
...
writeFileSync(join(here, 'Tasks.js'), out);
console.log('wrote app/Tasks.js', out.length, 'bytes');
